...
use Hakimace\FilamentApiLogin\Services\ExternalAuthService;
...
class ExternalAuthServiceTest extends TestCase
{
  ...
  {
    parent::setUp();
    $this->service = new ExternalAuthService('http://test-api.com/auth');
  }
  ...
  public function test_timeout_configuration_is_respected()
  {
    ...
    $service = new ExternalAuthService('http://test-api.com/auth', 5);
