...
class SessionGuardTest extends TestCase
{
  ...
  public function test_guest_returns_opposite_of_check()
  {
    ...
    // Create a fresh guard for the second check to avoid the cached user
    $freshGuard = new SessionGuard($this->request, $this->session);
    $this->assertTrue($freshGuard->guest());
  }
